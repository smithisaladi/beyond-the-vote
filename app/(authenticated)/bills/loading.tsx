        ...
        <main className="flex-1 px-6 py-10">
          <div className="max-w-3xl mx-auto animate-pulse">
            ...
            <div className="flex gap-3 mb-8">
              <div className="flex-1 h-10 bg-white rounded-lg border border-[#D6CFC4]" />
              <div className="w-24 h-10 bg-white rounded-lg border border-[#D6CFC4]" />
            </div>
            ...
            <div className="flex flex-col gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl border border-[#D6CFC4] shadow-sm p-6"
                >
