-- Fix contributor_leaderboard:
-- 1. Resolve names from fec_cmte_names instead of legislator_top_pacs
-- 2. total_contributions = direct + ie_for (exclude ie_against, matching pac_detail)
