...
export function RepresentativeCard({ name, title, party, state, district, since, photo }: RepresentativeCardProps) {
  const [following, setFollowing] = useState(false)
  const badge = PARTY_STYLES[party]

  return (
    <div className="bg-white rounded-xl border border-[#D6CFC4] shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center gap-4">
      {photo
