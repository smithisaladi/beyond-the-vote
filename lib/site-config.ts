 ...
 *
 * Production deployments should set `NEXT_PUBLIC_SITE_URL` in the hosting
 * environment (e.g. Vercel Project Settings). The fallback URL is only used
 * for local development and is not expected to match the production origin.
 */
