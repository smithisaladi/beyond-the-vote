...
@Entity
@Immutable
@Table(name = "independent_expenditures")
public class IndependentExpenditure {
    ...
    @Column(name = "sup_opp", nullable = false, length = 1)
    private Character supOpp;
    ...
    protected IndependentExpenditure() {
    }
