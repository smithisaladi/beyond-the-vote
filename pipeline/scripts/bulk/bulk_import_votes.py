    ...
    for session in [1, 2]:
        ...
        while True:
            ...
            for vote_stub in votes_list:
                ...
                vote_ids.append(vote_id)
                pending_checkpoints.append((source_file, int(str(roll_call))))
            ...
            # Mark checkpoints only after successful DB writes
            for sf, rc in pending_checkpoints:
                mark_checkpoint(SCRIPT, sf, rc, 1, "success")
