...
from sqlalchemy import BigInteger, Date, Numeric, SmallInteger, Text
...
class PacToCandidate(Base):
    ...
    transaction_dt: Mapped[Optional[date]] = mapped_column(Date, nullable=True)
