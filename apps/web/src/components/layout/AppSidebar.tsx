...
const NAV_ITEMS = [
  { label: 'Home',            href: '/home',            icon: <LayoutDashboard size={16} strokeWidth={1.8} /> },
  { label: 'My Politicians', href: '/representatives', icon: <Users size={16} strokeWidth={1.8} /> },
  { label: 'Bills Tracker',  href: '/bills',           icon: <ScrollText size={16} strokeWidth={1.8} /> },
  { label: 'Donors',         href: '/donors',          icon: <CircleDollarSign size={16} strokeWidth={1.8} /> },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ minHeight: 56, padding: collapsed ? '0' : '0 16px' }}
      >
        {collapsed ? (
        ...
        {NAV_ITEMS.map((item) => {
          ...
          if (collapsed) {
            return (
              <Link
                ...
                className={`flex items-center justify-center py-2 mx-2 rounded-lg transition-colors ${
                  active
          ...
          return (
            <Link
              key={item.label}
              to={item.href}
              className={`flex items-center gap-3 py-2 rounded-lg text-[13px] transition-colors pl-3 pr-3 ${
                active
