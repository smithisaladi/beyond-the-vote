    ...
    >
      <defs>
        <pattern id="topo-landing" x="0" y="0" width="900" height="700" patternUnits="userSpaceOnUse">
          <ellipse cx="700" cy="200" rx="420" ry="300"="none" stroke="#1C1C1A" strokeWidth="1.2" />
          <ellipse cx="700" cy="200" rx="340" ry="240"="none" stroke="#1C1C1A" strokeWidth="1.2" />
          <ellipse cx="705" cy="197" rx="265" ry="185"="none" stroke="#1C1C1A" strokeWidth="1.2" />
          <ellipse cx="708" cy="194" rx="195" ry="135"="none" stroke="#1C1C1A" strokeWidth="1.2" />
          ...
          <ellipse cx="120" cy="580" rx="180" ry="120"="none" stroke="#1C1C1A" strokeWidth="1" />
      ...
      <rect width="100%" height="100%"="url(#topo-landing)" />
    </svg>
  )
}
...
export function IconSearch() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24"="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
